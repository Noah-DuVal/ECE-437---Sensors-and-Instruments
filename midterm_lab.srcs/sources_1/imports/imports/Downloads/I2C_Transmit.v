...
module I2C_Transmit(    
    ...
    wire [31:0] sub_addr, dev_addr;
    wire [31:0] data_in;
    reg [7:0] data_out_temp, data_out;
    wire [31:0] stop_read;
    reg [31:0] read_counter;
    wire stop_flag_wire;
    wire [31:0] r_w;
    reg stop_flag;
    assign stop_flag_wire = stop_flag;
    ...
    always @(posedge FSM_Clk) begin              
        case (State)
            ...
            STATE_INIT : begin
                 if (PC_control == 32'b1) 
                      State <= 8'd1;               
                 else if (PC_control == 32'b0) begin                 
                      SCL <= 1'b1;
                      SDA <= 1'b1;
                      State <= 8'd0;
                  end
          ...
          // 8'd41 : begin
           ...
           // end              
            ...
            8'd150 : begin 
                SCL <= 1'b0; 
                SDA <= 1'bz;
                if (read_counter == stop_read[3:0]) begin
                    State <= 8'd183;
                    stop_flag <= 1'b0;
                end
                else begin
    ...
    okWireOut wire22 (.okHE(okHE),
                      .okEH(okEHx[1*65+:65]),
                      .ep_addr(8'h22),
                      .ep_datain({31'b0,stop_flag_wire}));
